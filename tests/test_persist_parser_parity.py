...
class _NoopLiveness:
    ...
    drive's in-flight gate (``observe_prompt_start/end``) + any other liveness
    poke. The parity suite exercises only persistence/coalescing, not reaper
    behavior, so these are no-ops."""
